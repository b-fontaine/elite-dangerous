...
class _SpanshRouteApi implements SpanshRouteApi {
  _SpanshRouteApi(this._dio, {this.baseUrl, this.errorLogger}) {
    baseUrl ??= 'https://spansh.co.uk';
  }
